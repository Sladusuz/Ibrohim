...
- `bisraro-front.png`, `bisraro-back.png` — 600 dpi rasm (PDF shu rasmlardan yig'iladi — telefonda ham, bosmaxonada ham bir xil ko'rinadi)
...
Qayta yaratish: `python3 build.py && PW=$(npm root -g)/playwright node render.js && python3 make_pdf.py && PW=$(npm root -g)/playwright node plain.js`
